...
func main() {
	...
	var (
		...
		extraDirs    = flag.String("extra-dirs", "", "Additional Claude project root directories to scan (comma-separated, supports glob patterns). Also set via CCDASH_EXTRA_DIRS env var (colon-separated, supports glob patterns)")
	)
	...
	if *installHooks {
		...
		fmt.Println("  • Notification       - Marks session as asking (mid-turn question)")
...
func printHelp() {
	...
	fmt.Println("                        Comma-separated list of paths, supports glob patterns")
	fmt.Println("                        Example: /home/user/projects/*,/home/user/work/*/sessions")
	...
	fmt.Println("  2            Focus on Network I/O panel")
	fmt.Println("  3            Focus on Token Usage panel")
	fmt.Println("  4            Focus on Sessions panel")
	fmt.Println()
	fmt.Println("PANELS:")
	fmt.Println("  System Resources  - CPU, memory, swap, disk I/O, and load averages")
	fmt.Println("  Network I/O       - Bandwidth usage per interface (recv/sent rates)")
	...
	fmt.Println("  ccdash --extra-dirs='/home/*/projects'    Scan with glob pattern")
	fmt.Println("  CCDASH_EXTRA_DIRS=/path1:/path2 ccdash    Use env var for extra directories")
	fmt.Println("  CCDASH_EXTRA_DIRS='/home/*/projects' ccdash Use env var with glob patterns")
	fmt.Println()
